...
Funcionalidade: Criar Tópico na Base de Conhecimento
    ...
    Cenário: Criar um novo tópico com sucesso
    ...
    Cenário: Criar um tópico sem título
      Dado que estou autenticado como gestor de conteúdo
      E acesso a página de gerenciamento da Base de Conhecimento
    ...
    Cenário: Criar um tópico com título duplicado no mesmo tema
      Dado que estou autenticado como gestor de conteúdo
      E acesso a página de gerenciamento da Base de Conhecimento
